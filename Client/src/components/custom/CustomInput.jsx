  ...
  return (
    <div className="w-full relative h-max rounded-lg overflow-hidden">
      ...
      <input
        ...
        className={`w-full transition-all duration-300 focus:outline-none focus:border-blue-700 rounded-lg border-2 overflow-hidden border-gray-400 border-spacing-0 py-2 px-3 min-w-[300px] ${
          focus || value ? "pt-6" : ""
        }`}
        value={value}
